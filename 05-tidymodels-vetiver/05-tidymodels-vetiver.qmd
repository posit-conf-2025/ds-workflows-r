...
posit_cola_data <- read_csv("data/posit_cola_sales_data.csv")
```
...
vetiver_model_lm <- vetiver_pin_read(board, "ryan/posit_cola_revenue_model", version = "758134")

# Load the vetiver model rf
vetiver_model_rf <- vetiver_pin_read(board, "ryan/posit_cola_revenue_model", version = "758136")
