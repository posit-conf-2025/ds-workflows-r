...
vetiver_deploy_rsconnect(board = board, name = "____/posit_cola_revenue_model")
```
...
pin_versions(board = board, name = "____/posit_cola_revenue_model")

# We can also extract some metadata from the pin
pin_meta(board = board, name = "____/posit_cola_revenue_model")$description
```
...
vetiver_model_lm <- vetiver_pin_read(board, "____/posit_cola_revenue_model", version = "758134")

# Load the vetiver model rf
vetiver_model_rf <- vetiver_pin_read(board, "____/posit_cola_revenue_model", version = "758136")
