---
title: "Clean and Validate Cola Sales Data"
format:
  email:
    toc: true
    toc-location: left
...
the action is yet to come. Next step is to run it with **interrogate**!
...
Pointblank has identified all of the rows of `data` that
...
Pointblank provides a number of [post-interrogation functions](https://rstudio.github.io/pointblank/reference/index.html#post-interrogation) to
...
fail statistics (e.g., `$n_passed`, `$n_failed`, `$f_passed`, `$f_failed`). Take a look:
