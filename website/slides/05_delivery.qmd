...
- Add logging to your app for benchmarking, performance tracking, debugging, and/or tracking actions
  - output to STDOUT/STDERR and see in the Connect app logs (example in our [Ferry Delay App](https://github.com/posit-conf-2025/ds-workflows-r/blob/main/materials/05-shiny-app/ferry_delay_app/app.R))
