...
-   Tip! Use "Notebook Layout" for more screen real estate to explore the data. Afterwards, change back to the "Stacked Layout" for the 4-pane data science experience.
...
scan <- pointblank::scan_data(data, sections = "OVMS")
